...
// event "polyfill"
sportsx.createEvent = function (eventName) {
    var event;
    ...
    hideAndShowModals: function () {
        ...
        modals.forEach(function (modal) {
            modal.addEventListener('toggle-target-before-inactive', function (event) {
                ...
                _win.sportsx.scrolled = parseInt(styles.top, 10);
                if (adminBar) {
                    if (mQuery.matches) {
            ...
            modal.addEventListener('toggle-target-after-inactive', function (event) {
                ...
                setTimeout(function () {
                    var clickedEl = sportsx.toggles.clickedEl;
...
sportsx.modalMenu = {
    ...
    expandLevel: function () {
        ...
        modalMenus.forEach(function (modalMenu) {
            ...
            if (activeMenuItem) {
                sportsxFindParents(activeMenuItem, 'li').forEach(function (element) {
                    var subMenuToggle = element.querySelector('.sub-menu-toggle');
                    if (subMenuToggle) {
                        sportsx.toggles.performToggle(subMenuToggle, true);
                    }
                });
            }
        });
    ...
    keepFocusInModal: function () {
        ...
        _doc.addEventListener('keydown', function (event) {
            var toggleTarget, modal, selectors, elements, menuType, bottomMenu, activeEl, lastEl, firstEl, tabKey,
                shiftKey, clickedEl = sportsx.toggles.clickedEl;
...
sportsx.toggles = {
    ...
    performToggle: function (element, instantly) {
        ...
        if (target.classList.contains(activeClass)) {
            target.dispatchEvent(sportsx.createEvent('toggle-target-before-active'));
        } else {
            target.dispatchEvent(sportsx.createEvent('toggle-target-before-inactive'));
        }
        ...
        setTimeout(function () {
            ...
            if (toggle.dataset.toggleType === 'slidetoggle' && !instantly && duration !== '0') {
                sportsxMenuToggle(newTarget, duration);
            } else {
            ...
            sportsxToggleAttribute(toggle, 'aria-expanded', 'true', 'false');
            if (self.clickedEl && -1 !== toggle.getAttribute('class').indexOf('close-')) {
                sportsxToggleAttribute(self.clickedEl, 'aria-expanded', 'true', 'false');
            }
            // Toggle body class.
            ...
            target.dispatchEvent(sportsx.createEvent('toggled'));
            // Trigger events on the toggle targets after they are toggled.
            if (target.classList.contains(activeClass)) {
                target.dispatchEvent(sportsx.createEvent('toggle-target-after-active'));
            } else {
                target.dispatchEvent(sportsx.createEvent('toggle-target-after-inactive'));
            }
        }, timeOutTime);
    },
    // Do the toggle.
...
sportsxDomReady(function () {
    sportsx.toggles.init();              // Handle toggles.
    sportsx.coverModals.init();          // Handle cover modals.
    sportsx.modalMenu.init();            // Modal Menu.
    sportsx.primaryMenu.init();          // Primary Menu.
    sportsx.touchEnabled.init();         // Add class to body if device is touch-enabled.
});
/*	-----------------------------------------------------------------------------------------------
	Helper functions
--------------------------------------------------------------------------------------------------- */
...
/* Toggle an attribute ----------------------- */
function sportsxToggleAttribute(element, attribute, trueVal, falseVal) {
    var toggles;
 ...
 */
function sportsxMenuToggle(target, duration) {
 ...
 */
function sportsxFindParents(target, query) {
    var parents = [];
